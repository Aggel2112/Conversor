...
public class principal {
    public static void main (String[] args) {
        ...
        ConversorTemperatura.funcionTemperatura temperatura = new funcionTemperatura();
             
        while(true) {
        	
        	String opciones = (JOptionPane.showInputDialog(null, "Escoja una opción de conversión ", "Menu", JOptionPane.QUESTION_MESSAGE, null, new Object[] {"Conversor de Moneda", "Conversor de Temperatura"}, "Seleccion")).toString();
